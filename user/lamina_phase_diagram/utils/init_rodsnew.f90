PROGRAM INIT_RODS
    ...
    !------------------------------------------------------------------------------------------------------
    ! 3) Check if `coords` already exists
    !------------------------------------------------------------------------------------------------------
    INQUIRE(FILE="coords", EXIST=EXISTING_FILE)
    IF (EXISTING_FILE) THEN
        PRINT *, "coords file exists, skipping random initialization."
    ELSE
        !------------------------------------------------------------------------------------------------------
        ! 4) Make random coords (only if first iteration)
        !------------------------------------------------------------------------------------------------------
        ...
        PRINT *, "Random angles written to coords file."
    ENDIF
    
    !------------------------------------------------------------------------------------------------------
    ! 5) Make initial positions
    !------------------------------------------------------------------------------------------------------
    DO I=1,N_ROD
        INITPOS(I,1) = 0.0
    ...
    PRINT *, "Initial positions and bonds written."
